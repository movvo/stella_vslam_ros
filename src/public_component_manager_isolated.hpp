...
#ifndef GEO_VSLAM__COMPONENT_MANAGER_ISOLATED_HPP__
#define GEO_VSLAM__COMPONENT_MANAGER_ISOLATED_HPP__
...
/// PublicComponentManagerIsolated uses dedicated single-threaded executors for each components.
template<typename ExecutorT = rclcpp::executors::SingleThreadedExecutor>
class PublicComponentManagerIsolated : public rclcpp_components::ComponentManager
{
  using rclcpp_components::ComponentManager::ComponentManager;

public:
  ~PublicComponentManagerIsolated()
  {
...
#endif  // GEO_VSLAM__COMPONENT_MANAGER_ISOLATED_HPP__
